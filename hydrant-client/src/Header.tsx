...
const Logo = () => (
  <a href="/" className="flex cursor-pointer w-min">
    <svg
      className="text-slate-900 mr-1 place-self-center"
    ...
    <div className="text-2xl text-slate-800 font-bold place-self-center">Hydrant</div>
  </a>
)

export const Header = () => (
  <div className="bg-slate-50 h-16 p-2 border-b flex justify-between">
    <Logo></Logo>
    <a
      target="_blank"
      href="https://github.com/Robert-Cunningham/hydrant"
      className="text-2xl place-self-center text-slate-400 hover:text-slate-600 cursor-pointer mr-3"
    >
      <FaGithub />
    </a>
  </div>
